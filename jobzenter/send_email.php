...
switch ($pdfFileName) {
    ...
    case 'full stack development.pdf':
        $service = 'Java Full Stack Development'; // updated label
        break;
    case 'POWER BI.pdf':
    ...
    // --- NEW COURSES (added) ---
    case 'JZ_CCNA_Course_Curriculum.pdf':          // ✅ CCNA brochure
        $service = 'Cisco Certified Network Associate';
        break;
    case 'Med_billing_JZ_Curriculum.pdf':          // ✅ Medical Billing brochure
        $service = 'Medical Billing';
        break;
    case 'JZ_MERN STACK.pdf':                      // ✅ MERN Stack brochure
        $service = 'MERN Stack Development';
        break;
    case 'React Native Full Stack Curriculum.pdf': // ✅ React Native brochure
        $service = 'React Native Full Stack';
        break;
    // --- END NEW ---
    ...
    case 'one_to_one_training.pdf':
        ...
        break;
    default:
        // Fallback: use the filename (without .pdf) as the label to avoid "Unknown Service"
        $service = pathinfo($pdfFileName, PATHINFO_FILENAME);
}
